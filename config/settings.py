...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'config.context_processors.admin_new_agent_requests',
            ],
        },
    },
]
...
JAZZMIN_SETTINGS = {
        ...
        'Объекты и каталог': [
            {
                ...
                'url': 'admin:accounts_maincategory_changelist',
                'icon': 'fas fa-tags',
                'permissions': ['accounts.view_propertycategory'],
            },
            {
                'name': 'Подкатегории',
                'url': 'admin:accounts_subcategory_changelist',
                'icon': 'fas fa-tag',
                'permissions': ['accounts.view_propertycategory'],
            },
            {
    ...
    'icons': {
        ...
        'accounts.maincategory': 'fas fa-tags',
        'accounts.subcategory': 'fas fa-tag',
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        ...
        {
            'name': 'Accounts — уведомления',
            'description': (
                'Уведомления агента об **отклонении** объекта модератором: GET список и GET по id '
                '(при открытии детали **`is_seen`** становится true). Создание записей — только из **админки**.'
            ),
        },
    ],
    'PREPROCESSING_HOOKS': [],
